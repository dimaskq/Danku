...
export default async function ResultsPage({ params, searchParams }: Props) {
  ...
  if (
    ...
    return (
      <div className="error">
        ...
        <Link href={`/tests/math/${grade}`} className="error__retake-button">
  ...
  // Decode topics and handle empty case
  ...
  return (
    <main className="results">
      <h1 className="results__title">
        Результати тесту з математики для {grade} класу
      </h1>
      <div className="results__card">
        ...
        <Link href={`/tests/math/${grade}`} className="results__retake-button">
          Пройти тест знову
        </Link>
      </div>
    </main>
